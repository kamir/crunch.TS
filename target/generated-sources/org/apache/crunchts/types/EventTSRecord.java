 ...
 */
package org.apache.crunchts.types;  
...
public class EventTSRecord extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public EventTSRecord(java.util.List<org.apache.crunchts.types.Event> eventArray, java.lang.CharSequence label, java.lang.Long tStart, java.lang.Long tEnd) {
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: eventArray = (java.util.List<org.apache.crunchts.types.Event>)value$; break;
   ...
   */
  public java.util.List<org.apache.crunchts.types.Event> getEventArray() {
    return eventArray;
  }
   ...
   */
  public void setEventArray(java.util.List<org.apache.crunchts.types.Event> value) {
  ...
  public static org.apache.crunchts.types.EventTSRecord.Builder newBuilder() {
    return new org.apache.crunchts.types.EventTSRecord.Builder();
  }
  
  /** Creates a new EventTSRecord RecordBuilder by copying an existing Builder */
  public static org.apache.crunchts.types.EventTSRecord.Builder newBuilder(org.apache.crunchts.types.EventTSRecord.Builder other) {
    return new org.apache.crunchts.types.EventTSRecord.Builder(other);
  }
  
  /** Creates a new EventTSRecord RecordBuilder by copying an existing EventTSRecord instance */
  public static org.apache.crunchts.types.EventTSRecord.Builder newBuilder(org.apache.crunchts.types.EventTSRecord other) {
    return new org.apache.crunchts.types.EventTSRecord.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<EventTSRecord>
    ...
    private java.util.List<org.apache.crunchts.types.Event> eventArray;
    ...
    private Builder() {
      super(org.apache.crunchts.types.EventTSRecord.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(org.apache.crunchts.types.EventTSRecord.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing EventTSRecord instance */
    private Builder(org.apache.crunchts.types.EventTSRecord other) {
            super(org.apache.crunchts.types.EventTSRecord.SCHEMA$);
    ...
    /** Sets the value of the 'eventArray' field */
    public org.apache.crunchts.types.EventTSRecord.Builder setEventArray(java.util.List<org.apache.crunchts.types.Event> value) {
    ...
    public org.apache.crunchts.types.EventTSRecord.Builder clearEventArray() {
      eventArray = null;
    ...
    /** Sets the value of the 'label' field */
    public org.apache.crunchts.types.EventTSRecord.Builder setLabel(java.lang.CharSequence value) {
    ...
    public org.apache.crunchts.types.EventTSRecord.Builder clearLabel() {
      label = null;
    ...
    /** Sets the value of the 'tStart' field */
    public org.apache.crunchts.types.EventTSRecord.Builder setTStart(long value) {
    ...
    public org.apache.crunchts.types.EventTSRecord.Builder clearTStart() {
    ...
    /** Sets the value of the 'tEnd' field */
    public org.apache.crunchts.types.EventTSRecord.Builder setTEnd(long value) {
    ...
    public org.apache.crunchts.types.EventTSRecord.Builder clearTEnd() {
    ...
    public EventTSRecord build() {
      try {
        ...
        record.eventArray = fieldSetFlags()[0] ? this.eventArray : (java.util.List<org.apache.crunchts.types.Event>) defaultValue(fields()[0]);
